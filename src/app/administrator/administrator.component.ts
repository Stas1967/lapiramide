...
export class AdministratorComponent {
  ...
  general: Section[] = [
    { id: 0, name: 'Apartamentos', icon: 'folder', updated: new Date('07/20/2023'), link: 'apartments', disabled: false, dbid: '' },
    { id: 1, name: 'Image list', icon: 'folder', updated: new Date('07/20/2023'), link: 'imagelist', disabled: false, dbid: '' },
    { id: 2, name: 'Eventos', icon: 'folder', updated: new Date('07/22/2023'), link: 'events', disabled: false, dbid: '' },
    { id: 3, name: 'Usuarios', icon: 'folder', updated: new Date('07/23/2023'), link: 'users', disabled: false, dbid: '' }
  ]
  chart: Section[] = [
    { id: 3, name: 'Lista de reservas', icon: 'folder', updated: new Date('07/23/2023'), link: 'bookinglist', disabled: false, dbid: '' }
  ]
